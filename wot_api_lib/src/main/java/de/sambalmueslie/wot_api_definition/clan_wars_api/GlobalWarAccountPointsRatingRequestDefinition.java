 ...
 * @autor Sambalmueslie
 */
@WotApiRequestDefinition(method = "wot/globalwar/accountpointsrating/")
public class GlobalWarAccountPointsRatingRequestDefinition extends WotRequestDefinition {

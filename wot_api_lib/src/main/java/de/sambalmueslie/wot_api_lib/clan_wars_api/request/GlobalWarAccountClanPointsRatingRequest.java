...
public class GlobalWarAccountClanPointsRatingRequest extends BaseWotRequest  {

	public GlobalWarAccountClanPointsRatingRequest(final java.lang.String map_id) {
		this.map_id = map_id;
	}

	@Override
	public String getMethod(  ) { 
		return "globalwar/clanpointsrating/";
	}
